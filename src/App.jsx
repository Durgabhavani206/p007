...
class App extends Component {
  constructor(){       /*to initialize the state we use constructor*/
    super();          /*{}this which is in the line 85 means we are trying to embard something on the webpage*/
    this.state = {
      searchkey: "",
      cards: [
        {
  ...
  handleSearch(e){
    this.setState({[e.target.name]:e.target.value});     /*for dynamic content we use {} */
  } 
  showPanel(card){
  ...
  render() {
    const {searchkey, cards, selectedcard} = this.state; /*here we  are declaring the state*//*map will acts as loop like forwhich is in the line 85*/
